...
if __name__ == '__main__':
    ...
    # with open(os.path.normpath("comparison/examples/evaluation.csv"), "w",
    ...
    #     for file1 in os.listdir("truth/examples"):
    #         truth_file = os.path.normpath(os.path.join("truth/examples", file1))
    #         for file2 in os.listdir("results/examples"):
    #             test_file = os.path.normpath(os.path.join("results/examples", file2))
    #             if file1 == file2:
    #                 writer.writerow([file1.split(".")[0],
    #                                  *evaluate_example_links(truth_file, test_file)])
    #                 break
