                ...
                for truth_row in truth_list:
                    ...
                    for test_row in test_list:
                        ...
                        if fuzz.ratio(truth_row[0], test_row[0]) >= 95:
                            ...
                            pr = fuzz.ratio(re.sub(re.compile(r" +"), " ", truth_row[1].lower()),
                                            re.sub(re.compile(r" +"), " ",test_row[1].lower()))
...
if __name__ == '__main__':
    ...
    # y = evaluate_links("truth/parse_links.csv", "results/parse_links.csv", "parse_links.csv")
    # print(x, y)
